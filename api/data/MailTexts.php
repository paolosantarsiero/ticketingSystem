  ...
  public static function getTexts() {
    return [
        'en' => [
          ...
          'USER_INVITE' => [
              'You have been invited - MinervaS',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Access system changed - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket created - MinervaS',
              'Ticket created',
        ...
        'de' => [
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket erstellt - MinervaS',
              'Ticket erstellt',
        ...
        'es' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Sistema de acceso cambiado - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket creado - MinervaS',
              'Ticket creado',
        ...
        'fr' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Système d\'accès modifié - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket créé - MinervaS',
              'Ticket créé',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nouvelle réponse - MinervaS',
              'Ticket répondu',
          ...
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} Billet fermé - MinervaS',
              'Billet fermé',
        ...
        'in' => [
          ...
          'USER_INVITE' => [
              'आपको आमंत्रित किया गया है - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} tiket dibuat - MinervaS',
              'टिकट बनाय',
        ...
        'it' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Il sistema di accesso è cambiato - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} ticket creato - MinervaS',
              'Ticket inviato',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Ticket risposto - MinervaS',
          ...
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} Ticket chiuso - MinervaS',
              'Ticket chiuso',
        ...
        'pt' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Sistema de acesso alterado - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket criado - MinervaS',
              'Ticket criado',
        ...
        'ru' => [
          'USER_SIGNUP' => [
              'Зарегистрироваться {{to}} - MinervaS',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Система доступа изменена - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Создан билет - MinervaS',
              'Создан билет',
        ...
        'tr' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Erişim sistemi değiştirildi - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Bilet oluşturuldu - MinervaS',
              'Bilet oluşturuldu',
        ...
        'gr' => [
          ...
          'PASSWORD_FORGOT' => [
              'Ανάκτηση κωδικού πρόσβασης - MinervaS',
          ...
          'USER_SYSTEM_DISABLED' => [
            'Το σύστημα πρόσβασης άλλαξε - MinervaS',
          ...
          'USER_SYSTEM_ENABLED' => [
            'Δημιουργία λογαριασμού - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Δημιουργήθηκε εισιτήριο - MinervaS',
        ...
        'nl' => [
          ...
          'USER_SYSTEM_DISABLED' => [
            'Toegangssysteem gewijzigd - MinervaS',
          ...
          'USER_SYSTEM_ENABLED' => [
            'Account is aangemaakt - MinervaS',
            'Account Aangemaakt',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Incident aangemaakt - MinervaS',
              'Incident aangemaakt',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nieuw antwoord - MinervaS',
              'Nieuw antwoord',
          ...
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} Incident gesloten - MinervaS',
        ...
        'pl' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Zmieniono dostęp do systemu - MinervaS',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Tworzenie zgłoszenia - MinervaS',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nowa odpowiedź - MinervaS',
          ...
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} Zamknięcie zgłoszenia - MinervaS',
              'Zgłoszenie zamknięto',
              'Hello, {{name}}. Zgłoszenie pod tytułem <i>{{title}}</i> zostało zamknięte.',
              'Możesz uzyskać dostęp do zgłoszenia poprzez jego numer lub kliknij w przycisk poniżej.'
          ],
          'TICKET_CREATED_STAFF' => [
              '#{{ticketNumber}} Utworzono zgłoszenie - MinervaS',
              'Zgłoszenie utworzono',
