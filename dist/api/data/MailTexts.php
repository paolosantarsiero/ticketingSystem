  ...
  public static function getTexts() {
    return [
        'en' => [
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket created - Takius',
              'Ticket created',
        ...
        'de' => [
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket erstellt - Takius',
              'Ticket erstellt',
        ...
        'es' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Sistema de acceso cambiado - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket creado - Takius',
              'Ticket creado',
        ...
        'fr' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Système d\'accès modifié - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket créé - Takius',
              'Ticket créé',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nouvelle réponse - Takius',
              'Ticket répondu',
          ...
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} Billet fermé - Takius',
              'Billet fermé',
        ...
        'in' => [
          ...
          'USER_INVITE' => [
              'आपको आमंत्रित किया गया है - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} tiket dibuat - Takius',
              'टिकट बनाय',
        ...
        'it' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Il sistema di accesso è cambiato - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} ticket creato - Takius',
              'Ticket inviato',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Ticket risposto - Takius',
          ...
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} Ticket chiuso - Takius',
              'Ticket chiuso',
        ...
        'pt' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Sistema de acesso alterado - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket criado - Takius',
              'Ticket criado',
        ...
        'ru' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Система доступа изменена - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Создан билет - Takius',
              'Создан билет',
        ...
        'tr' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Erişim sistemi değiştirildi - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Bilet oluşturuldu - Takius',
              'Bilet oluşturuldu',
        ...
        'gr' => [
          ...
          'PASSWORD_FORGOT' => [
              'Ανάκτηση κωδικού πρόσβασης - Takius',
          ...
          'USER_SYSTEM_DISABLED' => [
            'Το σύστημα πρόσβασης άλλαξε - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Δημιουργήθηκε εισιτήριο - Takius',
        ...
        'nl' => [
          ...
          'USER_SYSTEM_DISABLED' => [
            'Toegangssysteem gewijzigd - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Incident aangemaakt - Takius',
              'Incident aangemaakt',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nieuw antwoord - Takius',
              'Nieuw antwoord',
          ...
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} Incident gesloten - Takius',
        ...
        'pl' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Zmieniono dostęp do systemu - Takius',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Tworzenie zgłoszenia - Takius',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nowa odpowiedź - Takius',
          ...
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} Zamknięcie zgłoszenia - Takius',
              'Zgłoszenie zamknięto',
              'Hello, {{name}}. Zgłoszenie pod tytułem <i>{{title}}</i> zostało zamknięte.',
              'Możesz uzyskać dostęp do zgłoszenia poprzez jego numer lub kliknij w przycisk poniżej.'
          ],
          'TICKET_CREATED_STAFF' => [
              '#{{ticketNumber}} Utworzono zgłoszenie - Takius',
              'Zgłoszenie utworzono',
